...
INSERT INTO users (userName,userEmail,userPhoneNumber,userPassword,userCity,userType) VALUES ('yongxinglian','yongxinglian@gmail.com','6139638520','yongxinglian','Toronto','consumer');
...
VALUES
    ('bread1', 3.97, 100, 'bread', 'Y', 3, '2024-09-1'),
    ('bread2', 5.97, 150, 'bread', 'N', 2, '2025-08-05'),
    ('meat3', 18.99, 200, 'meat', 'Y', 3, '2024-08-15'),
    ('meat4', 6.74, 75, 'meat','N', 2, '2024-8-20'),
    ('fruit5', 8.97, 120, 'fruit', 'Y', 3, '2024-8-25'),
    ('fruit6', 6.43, 180, 'fruit', 'N', 2, '2024-9-10'),
    ('vegi7', 5.28, 90, 'vegi', 'Y', 3, '2025-9-05'),
    ('vegi8', 3.99, 250, 'vegi', 'N', 2, '2024-9-12'),
    ('dairy9', 6.08, 130, 'dairy', 'Y', 3, '2024-9-15'),
    ('dairy10', 5.89, 110, 'dairy', 'N', 2, '2024-9-01');
...
VALUES
    ...
    ('walmart',3,'fruit','2024-08-03'),
    ('loblaws',4,'meat','2024-08-01'),
    ('loblaws',4,'fruit','2024-08-03');
