...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <table class="search-tab" border="1">
            ...
            <tr>
                <td><%= discount.getUserID()%>
                </td>
                <td><%= discount.getDicountCompany() %>
                </td>
                <td><%= discount.getProductID()%>
                </td>
                <td><%= discount.getProductName() %>
                </td>
                <td><%= discount.getDiscountAmount() %>
                </td>
                <td><%= discount.getDiscountPrice() %>
                </td>

                <td><input type="number" id="quantity_<%= discount.getProductID() %>" min="0" step="0.001"></td>
                <td>
                    <button onclick="submitForm('<%= discount.getProductID() %>', '<%= discount.getDiscountAmount() %>')">
                        Buy
                    </button>
                </td>
            </tr>
