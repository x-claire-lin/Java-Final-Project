        ...
        <form action="${pageContext.request.contextPath}/purchase" method="post">
            <table class="search-tab">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn2" name="inquire" id="inquire" value="Query" type="submit">
                            Query
                        </button>
                    </td>
                    <td>
                        <button class="btn btn-primary btn2" type="button"
                                onclick="window.location='${pageContext.request.contextPath}/purchase?method=list'">
                            Manager
                        </button>
                    </td>
                </tr>
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td><%= user.getProductName()%>
                    </td>
                    <td><%= user.getDiscountAmount()%>
                    </td>
                    <c:if test="${user.getUserID() == null}">
                        <td>
                            <a class="link-update" href="javascript:;"
                               onclick="doBuy(${user.getUserId()}, ${user.getDiscountAmount()})">Buy</a>
                        </td>
                    </c:if>
                </tr>
                <% }%>
