...
<div>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <button onclick="submitForm('<%= s.getSubscriptionID() %>')">Delete</button>
            </td>
...
<div>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <button onclick="submitFormType('<%= t.getType() %>')">Add</button>
            </td>
...
<script>
    function submitForm(id) {
        ...
        alert("You deleted Subscription ID is " + id + "!");
    ...
    function submitFormType(type) {
        ...
        alert("The Subscription Type you added is " + type + "!");
